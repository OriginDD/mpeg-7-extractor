 ...
 *       &lt;sequence>
 *         &lt;element name="SummaryPreferences" type="{urn:mpeg:mpeg7:schema:2004}SummaryPreferencesType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="BrowsingLocation" type="{http://www.w3.org/2001/XMLSchema}anyURI" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="PreferenceCondition" maxOccurs="unbounded" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{urn:mpeg:mpeg7:schema:2004}PreferenceConditionType">
 *                 &lt;sequence>
 *                   &lt;element name="Genre" type="{urn:mpeg:mpeg7:schema:2004}TermUseType" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/extension>
 *             &lt;/complexContent>
 *           &lt;/complexType>
    ...
    extends DSType
{
    ...
    @XmlElement(name = "BrowsingLocation")
    @XmlSchemaType(name = "anyURI")
    protected List<String> browsingLocation;
    @XmlElement(name = "PreferenceCondition")
    protected List<PreferenceCondition> preferenceCondition;
    ...
    /**
     * Gets the value of the browsingLocation property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the browsingLocation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBrowsingLocation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getBrowsingLocation() {
        if (browsingLocation == null) {
            browsingLocation = new ArrayList<String>();
        }
        return this.browsingLocation;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PreferenceCondition }
     * 
     * 
     */
    public List<PreferenceCondition> getPreferenceCondition() {
        if (preferenceCondition == null) {
            preferenceCondition = new ArrayList<PreferenceCondition>();
        }
