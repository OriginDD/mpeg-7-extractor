...
/**
 * <p>Java class for SpokenContentLinkType complex type.
 * 
...
@XmlSeeAlso({
    SpokenContentLatticeType.Block.Node.WordLink.class,
    SpokenContentLatticeType.Block.Node.PhoneLink.class
})
public class SpokenContentLinkType {
