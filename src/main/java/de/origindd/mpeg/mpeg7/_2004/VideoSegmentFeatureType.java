...
/**
 * <p>Java class for VideoSegmentFeatureType complex type.
 * 
...
@XmlType(name = "VideoSegmentFeatureType", propOrder = {
    "temporalTransition",
    "representativeFeature",
    "motionActivity"
})
@XmlSeeAlso({
    MovingRegionFeatureType.class
})
public class VideoSegmentFeatureType
    extends VisualDSType
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the temporalTransition property.
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the representativeFeature property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
