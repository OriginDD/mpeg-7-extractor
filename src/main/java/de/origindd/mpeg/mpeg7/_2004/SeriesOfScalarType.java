...
/**
 * <p>Java class for SeriesOfScalarType complex type.
 * 
...
@XmlType(name = "SeriesOfScalarType", propOrder = {
    "raw",
    "min",
    "max",
    "mean",
...
@XmlSeeAlso({
    SeriesOfScalarBinaryType.class,
    AudioLLDScalarType.SeriesOfScalar.class
})
public class SeriesOfScalarType
    extends ScalableSeriesType
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the mean property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the random property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
