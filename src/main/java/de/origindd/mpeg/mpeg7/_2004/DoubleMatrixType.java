...
/**
 * <p>Java class for DoubleMatrixType complex type.
 * 
...
@XmlType(name = "DoubleMatrixType", propOrder = {
    "value"
})
@XmlSeeAlso({
    ProbabilityDistributionType.Moment.Value.class,
    ProbabilityDistributionType.Cumulant.Value.class
})
public class DoubleMatrixType {
