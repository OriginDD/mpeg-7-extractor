 ...
 *           &lt;complexType>
 *             &lt;simpleContent>
 *               &lt;extension base="&lt;urn:mpeg:mpeg7:schema:2001>countryCode">
 ...
 *           &lt;complexType>
 *             &lt;simpleContent>
 *               &lt;extension base="&lt;urn:mpeg:mpeg7:schema:2001>auxiliaryLanguageType">
 *                 &lt;attribute name="preferenceValue" type="{urn:mpeg:mpeg7:schema:2001}preferenceValueType" default="10" />
 *               &lt;/extension>
 *             &lt;/simpleContent>
 *           &lt;/complexType>
 ...
 *           &lt;complexType>
 *             &lt;simpleContent>
 *               &lt;extension base="&lt;urn:mpeg:mpeg7:schema:2001>ExtendedLanguageType">
 *                 &lt;attribute name="preferenceValue" type="{urn:mpeg:mpeg7:schema:2001}preferenceValueType" default="10" />
 *               &lt;/extension>
 *             &lt;/simpleContent>
 *           &lt;/complexType>
 ...
 *                 &lt;sequence>
 *                   &lt;element name="Rating" type="{urn:mpeg:mpeg7:schema:2001}RatingType" minOccurs="0"/>
 *                   &lt;element name="Reviewer" type="{urn:mpeg:mpeg7:schema:2001}AgentType" minOccurs="0"/>
 *                 &lt;/sequence>
 *                 &lt;attribute name="preferenceValue" type="{urn:mpeg:mpeg7:schema:2001}preferenceValueType" default="10" />
 *               &lt;/restriction>
 *             &lt;/complexContent>
 ...
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;extension base="{urn:mpeg:mpeg7:schema:2001}ParentalGuidanceType">
 *                 &lt;attribute name="preferenceValue" type="{urn:mpeg:mpeg7:schema:2001}preferenceValueType" default="10" />
 *               &lt;/extension>
 *             &lt;/complexContent>
 *           &lt;/complexType>
    ...
    extends DSType
{
    ...
    protected List<LanguageFormat> languageFormat;
    @XmlElement(name = "Language")
    protected List<Language> language;
    @XmlElement(name = "CaptionLanguage")
    protected List<CaptionLanguage> captionLanguage;
    ...
    protected List<ParentalGuidance> parentalGuidance;
     ...
     * 
     */
    public List<LanguageFormat> getLanguageFormat() {
        if (languageFormat == null) {
            languageFormat = new ArrayList<LanguageFormat>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CaptionLanguage }
     * 
     * 
     */
    public List<CaptionLanguage> getCaptionLanguage() {
        if (captionLanguage == null) {
            captionLanguage = new ArrayList<CaptionLanguage>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ParentalGuidance }
     * 
     * 
     */
    public List<ParentalGuidance> getParentalGuidance() {
        if (parentalGuidance == null) {
            parentalGuidance = new ArrayList<ParentalGuidance>();
        }
