...
public class DescriptionMetadataType
    extends de.origindd.mpeg.mpeg7._2004.DescriptionMetadataType
{

    @XmlElement(name = "ClassificationSchemeAlias")
    protected List<ClassificationSchemeAlias> classificationSchemeAlias;
     ...
     * {@link ClassificationSchemeAlias }
     * 
     * 
     */
    public List<ClassificationSchemeAlias> getClassificationSchemeAlias() {
        if (classificationSchemeAlias == null) {
            classificationSchemeAlias = new ArrayList<ClassificationSchemeAlias>();
        }
