...
package de.origindd.mpeg.mpegv.sedl;
...
import de.origindd.mpeg.mpegv.sev.FogType;
import de.origindd.mpeg.mpegv.sev.PassiveKinestheticForceType;
import de.origindd.mpeg.mpegv.sev.SprayingType;
import de.origindd.mpeg.mpegv.sev.TactileType;
import de.origindd.mpeg.mpegv.sev.VibrationType;
import de.origindd.mpeg.mpegv.sev.ActiveKinestheticType;
import de.origindd.mpeg.mpegv.sev.ColorCorrectionType;
import de.origindd.mpeg.mpegv.sev.LightType;
import de.origindd.mpeg.mpegv.sev.RigidBodyMotionType;
import de.origindd.mpeg.mpegv.sev.ScentType;
import de.origindd.mpeg.mpegv.sev.TemperatureType;
import de.origindd.mpeg.mpegv.sev.WindType;


/**
 * <p>Java class for EffectBaseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="EffectBaseType">
 *   &lt;complexContent>
 *     &lt;extension base="{urn:mpeg:mpeg-v:2010:01-SEDL-NS}SEMBaseType">
 *       &lt;sequence minOccurs="0">
 *         &lt;element name="SupplementalInformation" type="{urn:mpeg:mpeg-v:2010:01-SEDL-NS}SupplementalInformationType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "EffectBaseType", propOrder = {
...
@XmlSeeAlso({
    ...
    TactileType.class,
    LightType.class,
    PassiveKinestheticForceType.class,
    TemperatureType.class,
    SprayingType.class,
    ColorCorrectionType.class,
    VibrationType.class,
    FogType.class,
    ActiveKinestheticType.class
})
public abstract class EffectBaseType
    extends SEMBaseType
{

    @XmlElement(name = "SupplementalInformation")
    protected SupplementalInformationType supplementalInformation;
     ...
     * @return
     *     possible object is
     *     {@link SupplementalInformationType }
     *     
     */
    public SupplementalInformationType getSupplementalInformation() {
     ...
     *     
     */
    public void setSupplementalInformation(SupplementalInformationType value) {
