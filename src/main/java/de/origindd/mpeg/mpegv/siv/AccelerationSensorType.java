...
/**
 * <p>Java class for AccelerationSensorType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="Acceleration" type="{urn:mpeg:mpeg-v:2010:01-CT-NS}Float3DVectorType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "AccelerationSensorType", propOrder = {
    "acceleration"
})
public class AccelerationSensorType
    extends SensedInfoBaseType
{

    @XmlElement(name = "Acceleration")
    protected Float3DVectorType acceleration;
     ...
     *     
     */
    public Float3DVectorType getAcceleration() {
        return acceleration;
    }
     ...
     *     
     */
    public void setAcceleration(Float3DVectorType value) {
