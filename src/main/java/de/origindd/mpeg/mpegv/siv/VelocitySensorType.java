...
/**
 * <p>Java class for VelocitySensorType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="Velocity" type="{urn:mpeg:mpeg-v:2010:01-CT-NS}Float3DVectorType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "VelocitySensorType", propOrder = {
    "velocity"
})
public class VelocitySensorType
    extends SensedInfoBaseType
{

    @XmlElement(name = "Velocity")
    protected Float3DVectorType velocity;
     ...
     *     
     */
    public Float3DVectorType getVelocity() {
        return velocity;
    }
     ...
     *     
     */
    public void setVelocity(Float3DVectorType value) {
        this.velocity = value;
    }
