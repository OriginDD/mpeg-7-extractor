...
/**
 * <p>Java class for TextureBrowsingType complex type.
 * 
...
@XmlType(name = "TextureBrowsingType", propOrder = {
    "regularity",
    "directionAndScale"
})
public class TextureBrowsingType
    extends VisualDType
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "Direction", namespace = "urn:mpeg:mpeg7:schema:2004", type = JAXBElement.class),
        @XmlElementRef(name = "Scale", namespace = "urn:mpeg:mpeg7:schema:2004", type = JAXBElement.class)
    })
     ...
     * This is why there is not a <CODE>set</CODE> method for the directionAndScale property.
     * 
     * <p>
