    ...
    extends HeaderType
{
    ...
    public List<UniqueIDType> addPublicIdentifier(UniqueIDType uniqueIDType) {
        getPublicIdentifier().add(uniqueIDType);
    ...
    public List<CreatorType> addCreator(CreatorType creatorType) {
        getCreator().add(creatorType);
        return getCreator();
    }
