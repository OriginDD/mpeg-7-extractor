...
/**
 * <p>Java class for TemporalMaskType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="SubInterval" type="{urn:mpeg:mpeg7:schema:2004}MediaTimeType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TemporalMaskType", propOrder = {
    "subInterval"
})
public class TemporalMaskType
    extends MaskType
{

    @XmlElement(name = "SubInterval", required = true)
    protected List<MediaTimeType> subInterval;
     ...
     * 
     */
    public List<MediaTimeType> getSubInterval() {
        if (subInterval == null) {
            subInterval = new ArrayList<MediaTimeType>();
        }
