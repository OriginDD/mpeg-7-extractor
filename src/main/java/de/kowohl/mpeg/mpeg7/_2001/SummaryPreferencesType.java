 ...
 *           &lt;complexType>
 *             &lt;simpleContent>
 *               &lt;extension base="&lt;urn:mpeg:mpeg7:schema:2001>summaryComponentType">
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="SummaryDuration" type="{urn:mpeg:mpeg7:schema:2001}mediaDurationType" minOccurs="0"/>
 *         &lt;element name="MinSummaryDuration" type="{urn:mpeg:mpeg7:schema:2001}mediaDurationType" minOccurs="0"/>
 *         &lt;element name="MaxSummaryDuration" type="{urn:mpeg:mpeg7:schema:2001}mediaDurationType" minOccurs="0"/>
    ...
    extends DSType
{
    ...
    protected List<SummaryType> summaryType;
    @XmlElement(name = "SummaryTheme")
    protected List<SummaryTheme> summaryTheme;
     ...
     * 
     */
    public List<SummaryType> getSummaryType() {
        if (summaryType == null) {
            summaryType = new ArrayList<SummaryType>();
        }
     ...
     * 
     */
    public List<SummaryTheme> getSummaryTheme() {
        if (summaryTheme == null) {
            summaryTheme = new ArrayList<SummaryTheme>();
        }
